...
import (
	...
	"github.com/inpadi/7zip/internal/xz/internal/xlog"
...
// Close releases native decoder resources held by the active block. It does
// not close the compressed source supplied to NewReader.
func (r *Reader) Close() error {
	if r.closed {
		return nil
	}
	r.closed = true
	if r.sr != nil && r.sr.br != nil {
		return r.sr.br.closeFilter()
	}
	return nil
}
...
func (c *ReaderConfig) newBlockReader(xz io.Reader, h *blockHeader,
	...
	br.closer, _ = fr.(io.Closer)

	return br, nil
}

func (br *blockReader) closeFilter() error {
	if br.closer == nil {
		return nil
	}
	closer := br.closer
